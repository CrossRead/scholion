...
**Version 0.2.1** — first published as `0.1.0` on 16.08.2026. Not a medical
...
scholion demo          # a synthetic profile of a fictional person
...
The same core, four deliveries. Pick whichever fits how you work.
...
The instruction ships inside the package, so a model can be handed the file and
take it from there — including installing what is missing.

```bash
scholion skill           # the instruction itself (SKILL.md)

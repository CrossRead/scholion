...
**Version 0.3.2** — first published as `0.1.0` on 16.08.2026. Not a medical
...
**If a model is the only tool you have** — no terminal, no Python — take the
bundle. It is one file: hand it to the model and it installs the package and
takes it from there.

...
MESSAGES = {
    ...
    "version.since_head": 'Since {since}, {entries} of the journal ask for an action:',
    ...
    "web.update.pending": '{entries} of the journal ask for an action since then.',
    ...
    "tool.sch_system.param.key": "the system's key: thyroid, lipids, cardio, glucose, inflammation, adrenals, gonads, growth, pancreas, liver, micronutrients, renal, fitness. Omit to list them.",
    ...
    "screen.and_unread": "and the list is not read end to end — unread of its rows: {unread}, of a list of {total}",
    ...
    "screen.clear_partial": "nothing reportable was found, AND the list was not read end to end — unread of its rows: {unread}, of a list of {total} ({genes}). Over a gene nobody read «nothing found» is a statement about the file, not about the person",
    ...
    "decision.kind.asked_about": "asked about here, and nothing follows from it",
...
""",
    ...
    "system.kind.asked_about": 'asked about, nothing follows',
    ...
    "panel.signed.clinician": "sentence signed by a clinician on {on}; curated {curated}",
    "panel.signed.author": "sentence signed by the panel's author ({by}) on {on}, not by a clinician; curated {curated}",
    "panel.signed.open": "sentence is a draft from the named source; nobody has signed it; curated {curated}",
    ...
    "system.panel.kind.guideline": "A · to weigh when choosing a drug",
    ...
    "system.panel.kind.pair": "A · drug–gene pair, to weigh when choosing",
    "system.panel.kind.mechanism": "B · explains a marker",
    "system.panel.kind.asked_about": "C · asked about",
    ...
    "system.genetics.signature_author": "positions whose phrase is signed by the panel's author, and by no clinician: {n} (signed {date})",
    "system.genetics.signature_open": "rows whose sentence is a draft from the named source, not signed by a clinician: {n}",
    ...
    "system.row.signature_author": "signed by the panel's author on {date} — not by a clinician",
    "system.row.signature_clinician": "signed by a clinician on {date}",
    "system.row.signature_open": "the sentence is a draft from the named source — a clinician has not signed it",
